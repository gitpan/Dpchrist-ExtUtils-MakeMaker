#######################################################################
# $Id: MakeMaker.pm,v 1.24 2010-12-19 06:34:54 dpchrist Exp $
#######################################################################
# package:
#----------------------------------------------------------------------
...
sub _system_stderr
{
    my ($stdout, $stderr) = capture { system @_ };
    return $stderr;
}
...
sub pod2html
{
    ...
    if (_system_stderr 'pod2html --help') {
...
sub readme
{
    ...
    if (_system_stderr 'pod2text --help') {
	warn "WARNING 'readme': pod2text not found";
	goto DONE;
    }
...
EOF
    ...
    unless (_system_stderr 'pod2html --help') {
	$frag .= <<EOF2;
